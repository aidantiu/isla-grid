...
const copy = {
  ...
  tl: {
    ...
    description1: "Inaalok ng SparkPlug ang",
    islaGrid: "IslaGrid",
    description2: ", isang community-wide na pagpapalawig ng net-metering program. Binibigyan namin ng kapangyarihan ang mga barangay, LGU, at kooperatiba na maging micro-powerplant franchisees, na ginagamit ang kanilang lokal na heograpiya upang makaproduce, magbenta, at kumita mula sa renewable energy.",
