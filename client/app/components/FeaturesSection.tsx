...
const copy = {
  en: {
    title: "How It Works",
    heading: "A 5-Step Journey to Renewable Energy",
    subtitle: "From community analysis to AI-powered recommendations and expert guidance",
    ...
    step4Title: "Meralco Partnership Network",
    step4Description: "We collaborate with Meralco's trusted renewable energy subsidiaries and partners to ensure reliable hardware, seamless grid integration, and sustainable community power generation.",
  },
  tl: {
    title: "Paano Ito Gumagana",
    heading: "Isang 5-Hakbang na Paglalakbay sa Renewable Energy",
    subtitle: "Mula sa community analysis hanggang sa AI-powered na mga rekomendasyon at expert guidance",
    step1Badge: "Hakbang 1: Onboard at Pagsusuri",
    step1Title: "Community Profile Assessment",
    step1Description: "Sabihin sa amin ang tungkol sa iyong barangay o LGU. I-input ang inyong lokasyon, available natural resources, populasyon ng komunidad, at umiiral na infrastructure. Sinusuri ng aming AI ang data na ito upang maunawaan ang inyong natatanging renewable energy potential at mga hadlang.",
    ...
    step4Title: "Meralco Partnership Network",
    step4Description: "Nakikipagtulungan kami sa mga pinagkakatiwalaang renewable energy subsidiaries at partners ng Meralco upang masiguro ang maaasahang hardware, seamless grid integration, at sustainable community power generation.",
  },
} as const;
  ...
  return (
    <section id="features" className="py-24 bg-white">
      ...
      <div className="mt-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="mt-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="lg:w-1/2 lg:pr-10">
            ...
            <div className="mt-6 space-y-3">
              <p className="font-semibold text-[#131B28]">{t.step3QuestionsTitle}</p>
        ...
        {/* STEP 4: Meralco Partnership Network */}
        <div className="mt-20">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-flex items-center px-4 py-1 bg-green-100 text-green-800 text-sm font-medium rounded-full">
              {t.step4Badge}
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="p-6 bg-white rounded-2xl shadow hover:shadow-lg transition">
              <Image
                src="https://www.mspectrum.com.ph/sites/default/files/MSpectrum%20Logo%20Small_0.png"
                alt="MSpectrum Logo"
                width={160}
                height={60}
                className="mb-4 h-12 w-auto object-contain"
              />
              <h4 className="text-xl font-semibold text-[#131B28]">MSpectrum</h4>
              <p className="text-gray-600 text-sm mt-2">
                Meralco&apos;s solar subsidiary providing end-to-end solar solutions — from rooftop systems to community microgrids.
              </p>
            </div>

            <div className="p-6 bg-white rounded-2xl shadow hover:shadow-lg transition">
              <Image
                src="https://www.meralcopowergen.com.ph/wp-content/uploads/2025/09/MGEN-Brand-Logo-001-MGEN-Logo-1.png"
                alt="MGreen Logo"
                width={160}
                height={60}
                className="mb-4 h-12 w-auto object-contain"
              />
              <h4 className="text-xl font-semibold text-[#131B28]">MGreen</h4>
              <p className="text-gray-600 text-sm mt-2">
                MGen&apos;s renewable arm leading large-scale solar and battery projects, including the Terra Solar initiative.
              </p>
            </div>

            <div className="p-6 bg-white rounded-2xl shadow hover:shadow-lg transition">
              <Image
                src="https://www.bworldonline.com/wp-content/uploads/2021/05/BULACANSOL_LOGO_HORIZONTAL2-copy.png"
                alt="PowerSource Solar Icon"
                width={160}
                height={60}
                className="mb-4 h-12 w-auto object-contain"
              />
              <h4 className="text-xl font-semibold text-[#131B28]">PowerSource First Bulacan Solar</h4>
              <p className="text-gray-600 text-sm mt-2">
                A joint venture between PowerSource Energy and Meralco PowerGen, operating a 50 MWac solar farm in Bulacan.
              </p>
            </div>

            <div className="p-6 bg-[#F6F8FB] rounded-2xl shadow-inner flex flex-col items-center justify-center text-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-12 w-12 text-[#131B28] mb-3"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <h4 className="text-xl font-semibold text-[#131B28]">And More</h4>
              <p className="text-gray-600 text-sm mt-2">
                Our grid of installation, financing, and maintenance partners grows every quarter to serve more communities.
              </p>
            </div>
          </div>
        </div>
